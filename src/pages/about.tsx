    ...
    <Layout
      ...
      <main>
        <div className="container padding-top--md padding-bottom--lg">
          ...
          <p>
            Welcome to the world of AI-Native Driven Development. I am Muhammad Abdullah, a passionate Developer in the field of Artificial Intelligence and Cloud-Native technologies. With over 2 years of experience in architecting and implementing complex software systems, I've witnessed firsthand the transformative power of AI when integrated seamlessly into the development lifecycle.
          </p>
          <p>
